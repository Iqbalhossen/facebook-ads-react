...
const Header = () => {
  const { authUser, setUser, LoginWithEmail} = useContext(AuthContext);
                    ...
                    <div className="header-wrapper h-16">
                        ...
                        <div className="header-action header-action-end">
                            ...
                            <div>
                                ...
                                <li className="menu-item menu-item-light menu-item-hoverable mb-1 avatar2" ><Link className="flex gap-2 items-center" to="/user/profile/edit"><span className="text-xl opacity-50">
                                {/* icon  */}
                                    
                                    </span><span>Edit Profile</span></Link></li>
                                <li className="menu-item menu-item-light menu-item-hoverable mb-1 avatar2" ><Link className="flex gap-2 items-center" to="/user/password/change"><span className="text-xl opacity-50">
                                    
                                {/* icon  */}
                                    
                                    </span><span>Change Password</span></Link></li>
                                <li className="menu-item menu-item-light menu-item-hoverable mb-1 avatar2" >
                                    <Link className="flex gap-2 items-center" to="/"><span className="text-xl opacity-50">
                                    
                                {/* icon  */}
                                    
                                    </span><span>Home</span></Link></li>
