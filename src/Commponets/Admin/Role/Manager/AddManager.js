...
const AddManager = () => {
    ...
    const from = location.state?.from?.pathname || "/admin/manager/view";
   ...
   //  console.log(amounts);
    ...
    const handleInputBlur = event =>{
        ...
        const newManager = {...manager, role:"manager", picture:null,  status:0, created_at: setTime, update_at: null};
  ...
  <ProgressBar />
      ...
      <div className='mt-6 container'>
         <div className="grid grid-cols-12 gap-4 items-center">
          ...
          <Link to="/admin/manager/view" className="btn btn-outline btn-secondary">All Manager</Link>
          </div>
          </div>
