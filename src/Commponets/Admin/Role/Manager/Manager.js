...
const Manager = () => {
     ...
     useEffect(()=>{
        setLoading(true);
           fetch(`http://localhost:5000/role/manager/view`)
           .then(res=>res.json())
           .then(data => {
            setManager(data);
            setLoading(false);
    ...
    return (
        ...
        <div className="grid grid-cols-12 gap-4 items-center">
         <div className="col-start-1 col-end-10 ">
             <h2 className='text-lg font-semibold'>All Manager</h2>
         </div>
         <div className="col-end-2 col-span-2 ">          
         <Link to="/admin/manager/add" className="btn btn-outline btn-secondary">Add Manager</Link>
