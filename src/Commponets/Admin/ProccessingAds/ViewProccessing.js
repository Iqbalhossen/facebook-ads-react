        ...
        <div className='mt-6 container'>
            ...
            <div className='mt-6'>
                <div className="overflow-x-auto">
                    ...
                    <button onClick={()=> handleConfirm(AdsRequestShow._id)} className="btn btn-secondary my-8 mx-5">Complete</button>
...
export default ViewProccessing;