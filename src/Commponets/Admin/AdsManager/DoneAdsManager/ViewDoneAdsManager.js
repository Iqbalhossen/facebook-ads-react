...
const ViewDoneAdsManager = () => {
    ...
    const handleConfirm = (id) => {
        ...
        fetch(`http://localhost:5000/admin/ads/manager/done/${AdsRequestShow._id}`, {
            method: 'PUT',
            headers: {
            ...
            <div className='mt-6'>
                <div className="overflow-x-auto">
                    <div className="grid grid-cols-4 gap-4">
                        ...
                        <div>
                            <h5>Status  </h5>
                            <p><div className="badge badge-primary">Complete</div></p>
                        </div>
...
export default ViewDoneAdsManager;