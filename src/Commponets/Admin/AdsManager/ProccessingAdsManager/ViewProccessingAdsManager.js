...
const ViewProccessingAdsManager = () => {
    ...
    useEffect(() => {
        setLoading(true);
        fetch(`http://localhost:5000/admin/ads/manager/view/${id}`)
            .then(res => res.json())
            .then(data => {
    ...
    const handleConfirm = (id) => {
        ...
        fetch(`http://localhost:5000/admin/ads/manager/done/${id}`, {
            method: 'PUT',
            headers: {
            ...
            <div className='mt-6'>
                <div className="overflow-x-auto">
                    <div className="grid grid-cols-4 gap-4">
                        ...
                        <div>
                            <h5>Status  </h5>
                            <p><div className="badge badge-primary">processing</div></p>
                        </div>

                    </div>
                    <button onClick={()=> handleConfirm(AdsRequestShow._id)} className="btn btn-secondary my-8 mx-5">Confirm</button>
...
export default ViewProccessingAdsManager;