...
const ViewAdsManager = () => {
    ...
    const handleConfirm = (id) => {
        ...
        fetch(`http://localhost:5000/admin/ads/manager/payment/${id}`, {
            method: 'PUT',
            headers: {
            ...
            <div className='mt-6'>
                <div className="overflow-x-auto">
                    <div className="grid grid-cols-4 gap-4">
                        ...
                        <div>
                            <h5>Status  </h5>
                            <p><div className="badge badge-primary">Payment Pendding</div></p>
                        </div>
